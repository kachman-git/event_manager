                ...
                {currentEvents.map((event, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">{event.description}</TableCell>
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">{event.location}</TableCell>
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">{eventDate.toLocaleDateString()}</TableCell>
                      ...
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">{formatDistanceToNow(new Date(event.createdAt), { addSuffix: true })}</TableCell>
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-muted-foreground">{formatDistanceToNow(new Date(event.updatedAt), { addSuffix: true })}</TableCell>
                    </TableRow>
                  )
                })}
              </TableBody>
